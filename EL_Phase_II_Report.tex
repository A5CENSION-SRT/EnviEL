...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/anti_poaching_workflow.png}
    \caption{Real-Time Acoustic Anti-Poaching Workflow Sequence}
    \label{fig:anti_poaching_workflow}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/response_workflow.png}
    \caption{Ranger Alert Verification and Response Flowchart}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/system_at_a_glance.png}
...
ESP32 & I2C LCD & GPIO 21 (SDA) & SDA & System status display \\
ESP32 & I2C LCD & GPIO 22 (SCL) & SCL & System clock line \\
\midrule
Arduino Uno & MAX9814 Microphone & Pin A0 & OUT & Waveform streaming \\
Arduino Uno & Status LED & Pin 13 & VCC & Event detection blinker \\
Arduino Uno & SSD1306 OLED & Pin A4 (SDA) & SDA & Telemetry display \\
Arduino Uno & SSD1306 OLED & Pin A5 (SCL) & SCL & Telemetry clock \\
\bottomrule
\end{tabular}%
}
\end{table}
...
A web-based AI voice assistant enables rangers to query alerts, detection history, and system status using natural language voice commands. Text-to-speech responses allow safe, hands-free interaction during field operations.

\subsection{Web Application}
A Node.js backend with MongoDB stores and manages detection data, while a web dashboard displays alerts, trends, and system performance metrics.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/gunshot_waveform_noise_gate.png}
    \caption{Gunshot Acoustic Waveform vs. Noise Gate Threshold Gating}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/detection_pipeline.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/database_flow_diagram.png}
...
The following subsections present visual snapshots of the deployed software system.

\subsection{EcoGuard Landing Page Portal}
Figure~\ref{fig:ecoguard_landing} shows the public portal showcasing system operational status and conservation metrics.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/ecoguard_landing_page.png}
    \caption{EcoGuard Public Landing Page and Dashboard Portal}
    \label{fig:ecoguard_landing}
\end{figure}

\subsection{Interactive GIS Sensor Map}
Figure~\ref{fig:gis_map} illustrates the Leaflet GIS mapping interface displaying real-time node locations and status.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/gis_sensor_map.png}
    \caption{Interactive GIS Sensor Map showing Node Distribution in a Protected Forest Reserve}
    \label{fig:gis_map}
\end{figure}

\subsection{Ranger Control Dashboard}
Figure~\ref{fig:ranger_dashboard_snap} showcases the administrative dashboard displaying event status cards, real-time alert feed, and sensor uptime charts.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/ranger_dashboard.png}
    \caption{Ranger Control Dashboard featuring Live Threat Metrics and Sensor Feeds}
    \label{fig:ranger_dashboard_snap}
\end{figure}

\subsection{Poaching Events Log}
Figure~\ref{fig:events_log} shows the verification queue where park operators review, confirm, or flag alerts as false positives.
\begin{figure}[H]
    \centering
...
\subsection{AI Voice Assistant Interface}
Figure~\ref{fig:voice_chat} displays the conversational interface driven by Google Gemini 2.0 Flash for voice command mapping.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/gemini_voice_assistant.png}
