...
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/gunshot_waveform_noise_gate.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/noise_gate_detailed.png}
...
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/detection_pipeline.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/mfcc_pipeline_detailed.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{images/database_flow_diagram.png}
...
\subsection{EcoGuard Landing Page \& GIS Sensor Map}
Figures \ref{fig:ecoguard_landing} and \ref{fig:gis_map} present the public interface and the interactive geographic information system (GIS) mapping application:
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
        \centering
...
\subsection{Ranger Control Dashboard \& Poaching Events Log}
Figures \ref{fig:ranger_dashboard_snap} and \ref{fig:events_log} illustrate the operator metrics panel and the corresponding verification database logs:
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/ranger_dashboard.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/poaching_events_log.png}
...
Figure~\ref{fig:voice_chat} displays the conversational query interface driven by Google Gemini 2.0 Flash for ranger hands-free operation:
\begin{figure}[H]
    \centering
